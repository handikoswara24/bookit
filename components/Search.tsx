                ...
                <div className="col-10 col-lg-5">
                    <form className="shadow-lg" onSubmit={submitHandler}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" id="guest_field" value={guests} onChange={(e: any) => { setGuests(e.target.value) }}>
                        ...
                        <div className="form-group">
                            ...
                            <select className="form-control" id="room_type_field" value={category} onChange={(e: any) => setCategory(e.target.value)}>
                                {["King", "Single", "Twins"].map((category: any) => (
