...
import { getRoomReviews, clearErrors, deleteReview } from '../../redux/actions/roomActions'
...
const RoomReviews = () => {
    ...
    const { loading, error, reviews } = useSelector((state: any) => state.roomReviews)
    ...
    const deleteReviewHandler = (id: any) => {
